      ...
      <div className='col-span-2 bg-slate-300'>
          <div>
            <ul className='mt-12 text-center h-screen'>
                ...
                <li onClick={()=>navigate('/dashboard/all-orders')} className='my-9 hover:bg-slate-500 hover:cursor-pointer px-14 py-4'>All Orders</li>
                <li onClick={()=>navigate('/dashboard/add-products')} className='my-9 hover:bg-slate-500 hover:cursor-pointer px-14 py-4'>Add Products</li>
                <li onClick={()=>navigate('/dashboard/all-products')} className='my-9 hover:bg-slate-500 hover:cursor-pointer px-14 py-4'>All Products</li>
