  ...
  allProducts?.map(product=>{
    ...
    return (
       <div className={fixed ? 'sticky z-50 bg-white top-0 ' : ""}>
           ...
           <div className="grid md:grid-cols-4 grid-cols-2 items-center ">
               ...
               <div className='col-span-2 hidden md:inline-block'>
                 ...
                 <NavLink to='/canteen' >   <li >canteen</li></NavLink>
                 <NavLink to='/home' >   <li >Contact</li></NavLink>
               ...
               <div>
                   ...
                   <button className='ml-3 mr-5 relative   shop-icons' onClick={()=>setCartModal(!cartModal)}><FontAwesomeIcon id='cart' icon={faShoppingCart} className="text-2xl  transition ease-in-out delay-150   hover:scale-110  duration-300 ... "/>  <p id='cart-badge' className='bg-orange-500 w-4 rounded-2xl h-6  icons-badge text-sm -z-10'> {totalQuantity} </p> </button>
       ...
       { searchIcon &&    <div className=' text-center  md:hidden  '>
                   ...
                   <button className='bg-orange-400 text-sm py-2 -translate-x-6 font-semibold px-4 rounded shadow '>
